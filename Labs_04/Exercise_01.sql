-- 1. Napisz polecenie, które oblicza wartość sprzedaży dla każdego zamówienia w tablicy order details i zwraca
-- wynik posortowany w malejącej kolejności (wg wartości sprzedaży).
